    ...
    return (
      <div className={styles.container}>
        ...
        <p>
          ...
          places to eat and drink at, some of the city's majestic monuments,
          greenest parks and oldest temples. You'll never have to worry about an
          ...
          destination and don't want to look back.
        </p>
      </div>
    );
}
